    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                url = "https://github.com/kubbidev/EvonyaCore"
                ...
                issueManagement {
                    system = "GitHub"
                    url = "https://github.com/kubbidev/EvonyaCore/issues"
                }
            }
        }
    }
...
tasks.shadowJar {
    archiveFileName = "EvonyaCore-${projectVersion}.jar"
    mergeServiceFiles()
    dependencies {
