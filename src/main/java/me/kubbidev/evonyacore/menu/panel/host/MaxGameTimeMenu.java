...
public class MaxGameTimeMenu extends Menu {

    public MaxGameTimeMenu(PlayerMenuUtility playerMenuUtility, EvonyaPlugin plugin) {
    ...
    public void setMenuItems() {
        ...
        inventory.setItem(49, new Item(Material.WATCH)
                .setName("&8┃&6 Temps maximal de jeu")
                .setLore(Collections.singletonList("  &8•&a " + Utils.getFormattedTime(gameInstance.getMaxGameTime())))
                .addEnchantments(Enchantment.DURABILITY, 1)
                .addItemFlags(ItemFlag.HIDE_ENCHANTS)
    ...
    public void handleMenu(InventoryClickEvent event) {
        ...
        switch (material) {
            ...
            case BEACON:
                ...
                return;
            case SKULL_ITEM:
                final long time = gameInstance.getMaxGameTime();
                long finalTime = time;
                ...
                gameInstance.setMaxGameTime(finalTime);
                player.sendMessage(EvonyaPlugin.PREFIX + "Temps maximal de jeu &8»&c " + Utils.getFormattedTime(finalTime) + "&f.");
                break;
        }
        super.open();
    }
